...
const AddEmployee = () => {
  ...
  const [email, setEmail] = useState("");           // ✅ Added missing email
  ...
  const handleAddEmployee = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:8080/api/auth/register", {
        ...
        username,
        password,
        rolenames: [role], // ✅ Backend expects 'rolenames' as array
      });
    ...
    <>
      ...
      <div className="container mt-5">
        ...
        <form onSubmit={handleAddEmployee} style={{ maxWidth: "600px" }}>
          ...
          <div className="mb-3">
            <label className="form-label">Email</label> {/* ✅ Add email field */}
            <input
              type="email"
              className="form-control"
              value={email}
